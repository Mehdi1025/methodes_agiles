                ...
                <nav class="flex-1 p-4 overflow-y-auto space-y-6">
                    ...
                    <div>
                        ...
                        <a href="{{ route('assistant-ia.index') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('assistant-ia.*') ? 'bg-slate-800 text-teal-400' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white' }}">
                            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
